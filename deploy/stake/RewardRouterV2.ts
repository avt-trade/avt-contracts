...
const deployFunction: DeployFunction = async function ({
  ...
  const alpReferralReward = await ethers.getContract('AlpReferralReward')
  ...
  // allow rewardRouter to manage alpReferralReward
  await sendTxn(alpReferralReward.setHandler(rewardRouter.address, true), 'alpReferralReward.setHandler(rewardRouter)')
}
