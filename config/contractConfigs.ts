...
export const contractConfigs: { [networkName: string]: any } = {
  ...
  op_mainnet: {
    ...
    fastPriceFeed: {
      ...
      maxTimeDeviation: 60 * 60,
      minAuthorizations: 1,
      signer: ['0x45C26F6a24d058e6f8c343085f2cC24382E3C02C', '0xb79f261719C4312cBb79a990DB82752fEF707968'],
      updater: ['0x778e450c968CCeAf837c74e5D8AfdAe537e771ce'],
      keeper: ['0x7b8524f5Be3E4c9C375D292b88379c0bBefE97d2'],
    },
    positionManager: {
      depositFee: 30,
      orderKeeper: '0xC69625C3bDBa63aC30a85F82b9701f0591C58634',
      liquidator: '0x0c82531d46507628fa44fCf155256331A5c302F4',
    },
    positionRouter: {
      depositFee: 30,
      minExecutionFee: parseUnits('0.0001', 18),
